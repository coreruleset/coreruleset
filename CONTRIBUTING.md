...
```
 * Only the tags listed in the `approved_tags` list in [crs-linter.toml](crs-linter.toml) can be added to a rule. If you want to add a new tag, you **must** add it to this list.
