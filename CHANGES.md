 ...
 * Implement early blocking (Christian Folini) [#1955]
 * Refactor and rename anomaly scoring variables and paranoia level definition (Simon Studer) [#2417]
 * Add granular control over reporting levels in 9801xx rules (Simon Studer, Andrew Howe, Christian Folini) [#2482, #2488]
 * Made all formerly PCRE-only regular expressions compatible with Re2/Hyperscan WAF engines (Max Leske, Felipe Zipitria, Allan Boll, Franziska Bühler) [#1868, #2356, #2425, #2426, #2371, #2372]
 * Publish nightly packages (Felipe Zipitria) [#2207]
 * Drop HTTP/0.9 support to resolve FP (Federico G. Schwindt) [#1966]

New functionality and detections:
 ...
 * Detect path traversal in file upload (k4n5ha0, Franziska Bühler, Felipe Zipitria) [#2451]
 * Block access to AWS cli files (Jozef Sudolský) [#2439]
 * Detect /proc and /sys access attempts (Andrew Howe) [#2154]
 * Detect common IP-based SSRF targets (Felipe Zipitria) [#2259]
 * Detect email protocol attacks (Felipe Zipitria) [#2322]
 ...
 * Detect more unix RCE commands (Felipe Zipitria) [#2129]
 ...
 * Update backslashes to \x5c representation for better compatibility with known WAF engines (Andrew Howe, Max Leske) [#2335, #2345, #2375, #2376, #2399, #2400, #2402, #2410, #2420, #2441, #2442, #2454, #2426]
 * Don't cook hex escapes (Max Leske) [#2215]
 * Adapt rule 942440 to work in all ModSecurity versions (Andrew Howe) [#2201]
 ...
 * Fix FP in 'having' SQLi (Felipe Zipitria) [#2248]
 ...
 * Nextcloud: fix FPs (kam821, Jozef Sudolský, ntimo, Felipe Zipitria, pyllyukko) [#1840, #1843, #1847, #1946]
 ...
 * Move 'ecairn' from scanners to crawlers (Felipe Zipitria) [#2408]
 * 93231x rules: simplify already-lowercased regexps (Felipe Zipitria) [#2485]
 * remove double m,n in regexp (Felipe Zipitria) [#2484]
 * update OWASP vulnerability urls (Walter Hop) [#2467]
 * docs: update policy to include signed releases (Felipe Zipitria) [#2465]
 * Change documentation git module link to https (İlteriş Eroğlu) [#2461]
 * Optimize regex in 942440 (Felipe Zipitria) [#2459]
 ...
 * Add editorconfig file to keep spacing in good shape (Felipe Zipitria) [#2407]
 * Remove all whitespace at EOL (Felipe Zipitria) [#2405, #2406]
 * 920520: improve comment (Max Leske) [#2391]
 * Fix yamllint (Felipe Zipitria) [#2387]
 * README: fix typos (Priyam Patel) [#2494]
 * Initialization: fix typo (Elia Pinto) [#2366]
 * Fix changed Trustwave URLs (Elia Pinto, henkworks, Felipe Zipitria) [#2213, #2364, #2204]
 * Improve logging in some special cases (Jozef Sudolský) [#2347]
 * Rename nodejs to generic category (Felipe Zipitria) [#2340]
 * Fixed assembly of 920120-no-backtracking.data (Max leske) [#2333]
 * Move regexp-assembly to separate directory (Felipe Zipitria) [#2327]
 ...
 * docs: update links and format of known bugs (Felipe Zipitria) [#2186]
 ...
 * Fix donate URL (Felipe Zipitria) [#2132]
 ...
 * Fix Nginx logging in docker-compose (Felipe Zipitria) [#2036]
 ...
 * Add timezone variable to docker-compose (Felipe Zipitria) [#1995]
 ...
 * Tests: use same user-agent (Felipe Zipitria) [#2393]
 ...
 * Tests: add common and uniform http headers to tests (Felipe Zipitria) [#2362]
 ...
 * Tests: remove broken test 932100-3 (Felipe Zipitria) [#2165]
 * Tests: fix logging problem for Nginx (vijayasija99) [#2157]
 * Tests: use only valid YAML (Felipe Zipitria) [#2080]
