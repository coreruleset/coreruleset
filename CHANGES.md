 ...
 * Fix blind SQLi detection in rule 942160 PL1 (Franziska Bühler, Christian Folini) [#1956]
 * feat: new rule 934170 PL1 for PHP supporting `data:` scheme without using `//` before the content-type (Felipe Zipitría) [#3018]
 * fix: add local_file scheme from Python 2 in 931130 PL2 and 934120 PL2 (Felipe Zipitría) [#2809]
 * fix: update SQL reserved words in rule 942120 PL2 (Felipe Zipitría) [#2798]
 ...
 * fix: Adapt rule 942440 PL2 to work in all ModSecurity versions (Andrew Howe) [#2201]
 * Fix bypass in rule 931130 PL2 (Andrea Menin) [#2479]
 * Fix bypass in rule 933210 PL1 (Andrea Menin) [#2214]
 * Fix bypass in rule 942190 PL1 (Andrea Menin) [#1910]
 * Fix triple dot false negative in rules 930100 PL1, 930110 PL1 (Franziska Bühler) [#2309, #2310]
 * Fix false negative in rule 942230 PL1 (Max Leske) [#2348]
 * fix: avoid FP in rule 941310 PL1 with Russian characters (Max Leske) [#2107]
 * fix: avoid FP in rule 942300 PL2 by adding word boundary checks (Franziska Bühler) [#2099]
 * fix: avoid FP in rule 942230 PL1 with 'case' (Franziska Bühler) [#2035]
 * fix: avoid FP in rule 932115 PL1 on 'sort' (Franziska Bühler) [#2012]
 * fix: avoid FP in rule 933210 PL1 when cookie contains slash (Ervin Hegedus) [#1996]
 * fix: avoid FP in rule 932100 PL1 (Franziska Bühler) [#1954]
 * fix: avoid FP in rule 941120 PL2 by adding character limit (Christian Folini) [#1872]
 * fix: close bypass in rule 933210 PL1 (Walter Hop) [#2033]
 * Optimize regex in 942440 PL2 (Felipe Zipitría) [#2459]
 * 920520 PL1: improve comment (Max Leske) [#2391]
 * Fixed assembly of 920120 PL1-no-backtracking.data (Max Leske) [#2333]
 * Optimize regex in 942400 PL2 (Jozef Sudolský) [#2323]
 * Move 941120 PL2 from PL1 to PL2 (Christian Folini) [#2306]
 * Move 920300 PL3 from PL2 to PL3 (Franziska Bühler) [#2013]
 * Fix ReDoS in rule 942350 PL1 (Andrea Menin) [#2300]
 * Fix ReDoS in rule 941140 PL1 (Andrea Menin) [#2050]
 * Fix false negative in rule 920480 PL1 (katef, Federico G. Schwindt) [#1957]
 * Disassemble regexp in rule 930100 PL1 (Andrew Howe) [#2298]
 * Amend 920300 PL3 to exclude CONNECT requests (Andrew Howe) [#2297]
 * Restrict rule 941170 PL1 (Andrea Menin) [#2292]
 * Fix rule 9004110 to use newer format for var (Andrew Howe) [#2200]
 * Remove the fuzzy regularity of the 942310 PL2 rule (NiceYouKnow) [#2189]
 * Remove old commented-out rule 910110 PL1 (Paul Beckett) [#2148]
 * ownCloud: Fix rule 9003001 to match both DAV and WebDAV (Abu Dawud) [#2130]
 * Fix bug in rule 942190 PL1 and add test case (NiceYouKnow, Max Leske, Franziska Bühler) [#2112]
 * Fix chained condition for correlation rules 980120 and 980150 (Simon Studer) [#1898]
 * Detect Log4j / Log4Shell (932130 PL1) (Christian Folini, Max Leske, Andrew Howe) [#2349]
 * Detect Spring4Shell (944260 PL2) (Christian Folini, Andrea Menin) [#2464]
 * Detect JavaScript prototype pollution (934130 PL1, 934131 PL2)  (Walter Hop) [#2411]
 * feat: create new rule file to detect use of common web shells in response (955xxx PL1, 955350 PL2) (Jozef Sudolský, Andrea Menin) [#1962, #2039, #2116]
 * Deny uploading .jsp and .jspx files (944140 PL1) (Walter Hop) [#2456]
 * Detect path traversal in file upload (930100 PL1, 930110 PL1) (k4n5ha0, Franziska Bühler, Felipe Zipitría) [#2451]
 * Block access to AWS CLI files (930120 PL1, 930121 PL2) (Jozef Sudolský) [#2439]
 * Detect /proc and /sys access attempts (930120 PL1, 930130 PL1)  (Andrew Howe) [#2154]
 * Detect common IP-based SSRF targets (934110 PL1, 934120 PL2) (Felipe Zipitría) [#2259]
 * Detect email protocol attacks (932300 PL2, 932310 PL2, 932320 PL2) (Felipe Zipitría) [#2322]
 * Detect more error based SQL injections (942150 PL2, 951230 PL1) (Jozef Sudolský) [#2429]
 * Detect SQLi with 'drop' keyword (942350 PL1, 942360 PL1, 942200 PL2, 942362 PL2) (Jozef Sudolský) [#2218]
 * Detect RCE attempts with uninitialized shell vars (932200 PL2) (Andrea Menin) [#2151]
 * Detect more Unix RCE commands (932100 PL1, 932105PL1) (Felipe Zipitría) [#2129]
 * Detect SQLi with 'if exists' (942380 PL2) (NiceYouKnow) [#2121]
 * Detect SQLite system command injection (932210 PL2) (flo405, Andrea Menin, Christian Folini) [#2032]
 * Include IPv6 in Host Header check (920350 PL1) (itsTheFae, Ervin Hegedus, Jozef Sudolský) [#1929]
 * Block access to WEB-INF directory (930130 PL1) (Jozef Sudolský) [#2092]
 * Block access to various sensitive files (930120 PL1, 930121 PL2, 930130 PL1) (Jozef Sudolský) [#1960]
 * Improve SQLi detection with spaces (942190 PL1, 942390 PL2) (Manuel Spartan, Max Leske) [#2436]
 * Improve SQLi detection with 'not between' () (NiceYouKnow, Max Leske, Franziska Bühler) [#2115]
 * Lower FP by moving '-->' keyword to PL2 (942120 PL2) (Paul Beckett) [#2060]
 ...
 * Detect CensysInspect and seoscanners.net crawlers (913102 PL2) (Andrew Howe) [#2155]
 * Detect burpcollaborator scanner (913100 PL1) (Amir Hosein Aliakbarian) [#2152]
 * Detect QQGameHall malware (913100 PL1) (Walter Hop) [#2144]
 * Detect 'httpx' scanner (913100 PL1) (Will Woodson) [#2045]
 * Detect 'ecairn' crawler (913102 PL2) (Jozef Sudolský) [#2024]
 * Detect LeakIX scanner (913100 PL1) (Jozef Sudolský) [#1961]
 * Validate Accept-Encoding headers (920520 PL1, 920521 PL3) (Franziska Bühler) [#2357]
 * Deny access to sslvpn_websession (930130 PL1) (Jozef Sudolský) [#2338]
 * Detect 'Invoke-WebRequest' command (932120 PL1) (Paul Beckett) [#2271]
 ...
 * update: improve sampling mode efficiency (901410, 901420, 901440) (Paul Beckett) [#2094]
 * Move rules to the earliest phase possible based on their inputs (various rules) (Ervin Hegedus) [#1941]
 * Stop decoding things twice (920460 PL4) (Federico G. Schwindt) [#1845]
 * Move 'ecairn' from scanners to crawlers (913100 PL1) (Felipe Zipitría) [#2408]
 * 93231x rules: simplify already-lowercased regexps (932310 PL2) (Felipe Zipitría) [#2485]
 * remove double m,n in regexp (932131 PL2, 932311 PL3) (Felipe Zipitría) [#2484]
 ...
 * Fix attack type of a few rules (932180 PL1, 932200 PL2) (Jozef Sudolský) [#2324]
 * Web shells: optimize regexps (955120 PL1) (Jozef Sudolský) [#2315]
 * Fix logging by moving ctl action in chain to 2nd rule (954130 PL1) (Franziska Bühler) [#2202]
 * Added missing quotes from the end of actions list (930050) (Ervin Hegedus) [#2184]
 * Replace usage of ctl:ruleEngine=Off by ctl:ruleRemoveByTag=OWASP_CRS (901450, 905100, 905110) (Jozef Sudolský) [#2156]
 * Fix Sec-CH-UA and Sec-CH-UA-Mobile request header validation (920274 PL4, 920275 PL4) (somechris) [#2028]
 * Fix typo in message (920181 PL1) (Federico G. Schwindt) [#2011]
 * Fix magic number that crashes old PHP versions (942220 PL1) (Kyzentun, Walter Hop) [#2010]
 * Removing %{MATCHED_VAR} from logging (various rules) (Jozef Sudolský) [#1985]
 * Drop unneeded capture groups (920510 PL3, 932200 PL2, 942510 PL2, 942511 PL3) (Federico G. Schwindt) [#1983]
 * Add support for sec-ch-ua and sec-ch-ua-mobile within Validate Bytes (920274 PL4) (Chaim Sanders) [#1970]
 * Remove unneeded transformation from MATCHED_VARS (944120 PL1) (Federico G. Schwindt) [#1852]
 * Drop unneeded escapes (various rules) (Federico G. Schwindt) [#1842]
