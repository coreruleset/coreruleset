 ...
 * fix: avoid FP in rule 941310 with Russian characters (Max Leske) [#2107]
 * fix: avoid FP in rule 942300 by adding word boundary checks (Franziska Bühler) [#2099]
 * fix: avoid FP in rule 942230 with 'case' (Franziska Bühler) [#2035]
 * fix: avoid FP in rule 932115 on 'sort' (Franziska Bühler) [#2012]
 * fix: avoid FP in rule 933210 when cookie contains slash (Ervin Hegedus) [#1996]
 * fix: avoid FP in rule 932100 (Franziska Bühler) [#1954]
 * fix: avoid FP in rule 941120 by adding character limit (Christian Folini) [#1872]
 * fix: close bypass in rule 933210 (Walter Hop) [#2033]
