 ...
 * feat: extend rule to detect detection of restricted `method override` headers (Mark Zeman / KramNamez) [#3056]
 ...
 * fix: use correct anomaly scoring variable for rule 932236 PL2 (Ervin Hegedus) [#3112]
 ...
 * feat: extend rule to detect base64 evasion in XSS attacks (933160 PL1) (Franziska Bühler, 0SPwn) [#2567]
 ...
 * feat: new rule to detct PHP injection attacks without terminating semi-colon (rule 933211 PL3) (Karel Knibbe) [#2581]
 ...
 * feat: new rule to detect Node.js RCE detection (rule 934101 PL2) (rektor0) [#2578]
 ...
 * fix: use correct anomaly scoring variables and panaoia level tags across several rules (921170, 921220 PL4, 932220 PL2, 932331 PL3, 933211 PL3, 934101 PL1, 942362 PL2, 951100) (Christoph Hansen) [#2931]
