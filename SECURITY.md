...
4) Check if the exploit/vulnerability is covered at a higher Paranoia level by testing it against [CRS Sandbox](https://coreruleset.org/docs/6-development/6-4-using-the-crs-sandbox/) at a higher Paranoia level.
