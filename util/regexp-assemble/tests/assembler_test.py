...
'''
        ...
        assert output == [
            '(?:([\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)??[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?:[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?a[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?b[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?|[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?c[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?d[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?)|f[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?o[\\x5c\'\\"\\[]*(?:\\$[a-z0-9_@?!#{*-]*)?(?:\\x5c)?o|b[\\"\\^]*a[\\"\\^]*r)',
            'four',
            'five',
            's(?:even|ix)',
            'eight'
