...
PREFIX="##! File autogenerated by util/php-dictionary-gen with:"
...
PREFIX="$PREFIX -a $AGE_LIMIT -F $FREQUENCY_LIMIT -s $SPELL_PATH"
...
if [ "$DO_RULE_933161" == "1" ]; then
	...
	echo "$PREFIX" > $RA_FILE_PATH$R933161_FILENAME
